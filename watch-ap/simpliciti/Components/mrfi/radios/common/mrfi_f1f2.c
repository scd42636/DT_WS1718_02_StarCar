...
//  110
//};
// [BM] Changed channel settings to comply with local regulations
...
static const uint8_t mrfiRFPowerTable[] =
{
    0x0F,
    0x27,
    // [BM] Changed output power due to regulatory requirements
#ifdef ISM_EU
    0x67
#else
    #ifdef ISM_US
...
static const uint8_t mrfiRFPowerTable[] =
{
  ...
  0x8C,
    ...
    0x8B,  
         ...
         0x8D,
      #else 
        #error "Wrong ISM band specified (valid are ISM_EU and ISM_US)"
    #endif
  #endif
#endif
};

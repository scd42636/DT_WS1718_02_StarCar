...
const u8 lcd_font[] = {
    ...
    SEG_A + SEG_B + SEG_D + SEG_E + SEG_G,                 // Displays "Z" = 90
    SEG_A + SEG_F + SEG_E + SEG_D,                         // Displays "["
    SEG_F + SEG_G + SEG_C,                                 // Displays "\"
    SEG_A + SEG_B + SEG_C + SEG_D,                         // Displays "]"
    0,                                                     // Displays "^"
    SEG_D,                                                 // Displays "_"
    0,                                                     // Displays "`"
    SEG_E + SEG_G + SEG_C + SEG_D,                         // Displays "a"
    SEG_F + SEG_E + SEG_D + SEG_C + SEG_G,                 // Displays "b"
    SEG_G + SEG_E + SEG_D,                                 // Displays "c"
    SEG_E + SEG_G + SEG_C + SEG_D + SEG_B,                 // Displays "d"
    SEG_A + +SEG_D + SEG_E + SEG_F + SEG_G,                // Displays "e" -> "E"
    SEG_A + SEG_E + SEG_F + SEG_G,                         // Displays "f" -> "F"
    SEG_A + SEG_B + SEG_C + SEG_D + SEG_F + SEG_G,         // Displays "g"
    SEG_F + SEG_E + SEG_G + SEG_C,                         // Displays "h"
    SEG_E,                                                 // Displays "i"
    SEG_E + SEG_D,                                         // Displays "j"
    SEG_D + SEG_E + SEG_F + SEG_G,                         // Displays "k"
    SEG_E + SEG_F,                                         // Displays "l"
    SEG_A + SEG_B + SEG_C + SEG_E + SEG_F,                 // Displays "m" -> "M"
    SEG_C + SEG_E + SEG_G,                                 // Displays "n"
    SEG_C + SEG_D + SEG_E + SEG_G,                         // Displays "o"
    SEG_A + SEG_B + SEG_E + SEG_F + SEG_G,                 // Displays "p" -> "P"
    SEG_C + SEG_D + SEG_E + SEG_G,                         // Displays "q" -> "o"
    SEG_E + SEG_G,                                         // Displays "r"
    SEG_A + SEG_C + SEG_D + SEG_F + SEG_G,                 // Displays "s" -> "S"
    SEG_D + SEG_E + SEG_F + SEG_G,                         // Displays "t"
    SEG_C + SEG_D + SEG_E,                                 // Displays "u"
    SEG_C + SEG_D + SEG_E,                                 // Displays "v" -> "u"
    SEG_G,                                                 // Displays "w" -> "-"
    SEG_B + SEG_C + +SEG_E + SEG_F + SEG_G,                // Displays "x" -> "X"
    SEG_B + SEG_C + SEG_D + SEG_F + SEG_G,                 // Displays "y" -> "Y"
    SEG_A + SEG_B + SEG_D + SEG_E + SEG_G,                 // Displays "z" -> "Z"
};
